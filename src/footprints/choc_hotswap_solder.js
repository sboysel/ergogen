// Kailh Choc PG1350 (hotswap / solder combo)
module.exports = {
  params: {
    designator: 'S',
    from: undefined,
  ...
  body: p => {
    ...
    (module Kailh_socket_PG1350_optional (layer F.Cu) (tedit 5DD50F3F)
      ...
      (fp_line (start 6.9 -6.9) (end 6.9 6.9) (layer Eco2.User) (width 0.15))
      (fp_line (start -6.9 6.9) (end -6.9 -6.9) (layer Eco2.User) (width 0.15))
      (fp_line (start -9 -8.5) (end 9 -8.5) (layer F.Fab) (width 0.15))
      (fp_line (start 9 -8.5) (end 9 8.5) (layer F.Fab) (width 0.15))
      (fp_line (start 9 8.5) (end -9 8.5) (layer F.Fab) (width 0.15))
      (fp_line (start -9 8.5) (end -9 -8.5) (layer F.Fab) (width 0.15))
      ...
      (fp_text user %R (at 4.445 -7.62) (layer B.SilkS)
        (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
      )
      (fp_text user %V (at 2.54 -0.635) (layer B.Fab)
        (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
      )
      ...
      (pad "" np_thru_hole circle (at 5.5 0) (size 1.7018 1.7018) (drill 1.7018) (layers *.Cu *.Mask) ${p.from.str})
      (pad "" np_thru_hole circle (at -5.5 0) (size 1.7018 1.7018) (drill 1.7018) (layers *.Cu *.Mask) ${p.to.str})
    )
    `
  }
}
