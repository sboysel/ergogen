      ...
      if(p.hotswap) {
        ...
        if(p.mirror_holes) {
          return `
            ...
            (pad "" np_thru_hole circle (at ${def_pos}2.54 5.08) (size 2.286 2.286) (drill 1.4986) (layers *.Mask))
            (pad "" np_thru_hole circle (at ${def_neg}3.81 2.54) (size 2.286 2.286) (drill 1.4986) (layers *.Mask))
          `
        } else {
          return `
            ${''/* pins */}
