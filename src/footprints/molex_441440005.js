module.exports = {
  ...
  body: p => {
    ...
    (pad 7 smd rect (at -5.3300000000 2.6600000000 )(size 2.5400000000 5.2100000000)(layers F.Mask F.Paste F.Cu) ${p.GND.str})
    (pad 8 smd rect (at 5.3300000000 2.6600000000 )(size 2.5400000000 5.2100000000)(layers F.Mask F.Paste F.Cu) ${p.GND.str})
    ...
    (pad 7 smd rect (at -5.3300000000 2.6600000000 )(size 2.5400000000 5.2100000000)(layers B.Mask B.Paste B.Cu) ${p.GND.str})
    (pad 8 smd rect (at 5.3300000000 2.6600000000 )(size 2.5400000000 5.2100000000)(layers B.Mask B.Paste B.Cu) ${p.GND.str})
    (pad 1 smd rect (at -3.1750000000 -9.1349990000 )(size 0.6400000000 2.5400000000)(layers B.Mask B.Paste B.Cu) ${p.POWER.str})
    (pad 2 smd rect (at -1.9050000000 -9.1349990000 )(size 0.6400000000 2.5400000000)(layers B.Mask B.Paste B.Cu) ${p.TX.str})
    (pad 3 smd rect (at -0.6350000000 -9.1349990000 )(size 0.6400000000 2.5400000000)(layers B.Mask B.Paste B.Cu) ${p.TX.str})
    (pad 4 smd rect (at 0.6350000000 -9.1349990000 )(size 0.6400000000 2.5400000000)(layers B.Mask B.Paste B.Cu) ${p.RX.str})
    (pad 5 smd rect (at 1.9050000000 -9.1349990000 )(size 0.6400000000 2.5400000000)(layers B.Mask B.Paste B.Cu) ${p.RX.str})
    (pad 6 smd rect (at 3.1750000000 -9.1349990000 )(size 0.6400000000 2.5400000000)(layers B.Mask B.Paste B.Cu) ${p.POWER.str})
