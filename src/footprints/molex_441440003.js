module.exports = {
  ...
  body: p => {
    ...
    (module "44144-0003" (layer F.Cu)
      ...
      (pad 3 smd rect (at -1.905 -0.83 ${p.rot}) (size 0.64 2.54) (layers F.Cu F.Paste F.Mask) ${p.TX.str})
      (pad 4 smd rect (at -0.635 -0.83 ${p.rot}) (size 0.64 2.54) (layers F.Cu F.Paste F.Mask) ${p.TX.str})
      (pad 5 smd rect (at 0.635 -0.83 ${p.rot}) (size 0.64 2.54) (layers F.Cu F.Paste F.Mask) ${p.RX.str})
      ...
      (pad 3 smd rect (at -1.905 -0.83 ${p.rot}) (size 0.64 2.54) (layers B.Cu B.Paste B.Mask) ${p.TX.str})
      (pad 4 smd rect (at -0.635 -0.83 ${p.rot}) (size 0.64 2.54) (layers B.Cu B.Paste B.Mask) ${p.TX.str})
      (pad 5 smd rect (at 0.635 -0.83 ${p.rot}) (size 0.64 2.54) (layers B.Cu B.Paste B.Mask) ${p.RX.str})
