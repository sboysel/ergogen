...
module.exports = {
  ...
  body: p => {
    ...
    (module "TSSOP20" (version 20221018)
      ...
      (pad "P12" smd rect (at 2.2733 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P12 } (tstamp 8edf05cf-a60e-4236-8fbf-ad1443fd482a))
      (pad "P13" smd rect (at 1.62306 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P13 } (tstamp 240550be-b579-4054-9db5-9e8683909c19))
      (pad "P14" smd rect (at 0.97282 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P14 } (tstamp c4d7d2da-8520-4add-aba2-b96ed0278390))
      (pad "P15" smd rect (at 0.32258 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P15 } (tstamp 13fa6907-0a86-4d0a-ac29-1fffd1a653e1))
      (pad "P16" smd rect (at -0.32258 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P16 } (tstamp 4ec248f8-acdb-40ae-a202-8dde038366a0))
      (pad "P17" smd rect (at -0.97282 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P17 } (tstamp 03c35cd5-385c-4e84-b71b-68aff92bb421))
      (pad "P18" smd rect (at -1.62306 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P18 } (tstamp 604d9b65-7a77-44b1-9c1e-0747be156cb1))
      (pad "P19" smd rect (at -2.2733 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P19 } (tstamp fc952e06-9b1a-4dda-a15f-c2c9fdb8fc74))
      (pad "P20" smd rect (at -2.92354 ${ p.rot }) (size 0.39878 1.09982) (layers ${ p.side }.Cu ${ p.side }.Paste ${ p.side }.Mask) ${ p.P20 } (tstamp e7c9b196-65fd-4d75-945e-a599595a8f4c))
    )    
    `
    return body
  }
