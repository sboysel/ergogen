...
module.exports = {
    ...
    (module BAT_BAT-HLD-001 (layer F.Cu) (tedit 64E035EE)
      ...
      (pad P1 thru_hole rect (at -11.45 0.0 ${p.rot + 90}) (size 2.5 5.1) (layers *.Cu *.Mask *.Paste) ${p.pos.str})
      (pad P2 thru_hole rect (at 11.45 0.0 ${p.rot + 90}) (size 2.5 5.1) (layers *.Cu *.Mask *.Paste) ${p.pos.str})
